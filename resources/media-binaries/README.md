...
7. Forge's own `prePackage` hook runs the equivalent of `media:ensure`: when the
   ...
   Super-Build release and verifies it before packaging. Set
   `SUPER_MEDIA_AUTO_ACQUIRE=0` to keep an offline build fail-closed. Forge
