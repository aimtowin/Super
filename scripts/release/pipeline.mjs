...
function phaseMediaBuildLocally() {
  ...
  pipelineEnv.SUPER_MEDIA_SKIP_PROVENANCE = '1';
  process.env.SUPER_MEDIA_SKIP_PROVENANCE = '1';
...
function phaseE2E() {
  ...
  runReleaseScript('test:e2e:packaged', {
    SUPER_E2E_PACKAGED_EXECUTABLE: executable,
  });
}
...
function main() {
  ...
  console.log(`[release] Super v${currentVersion()} on ${currentPlatformKey()}`);
