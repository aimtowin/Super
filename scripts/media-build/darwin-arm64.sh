...
WORK=${SUPER_MEDIA_BUILD_DIR:-"$ROOT/.media-build/darwin-arm64"}
...
TRIPLET=super-arm64-osx-static
export VCPKG_ROOT
...
ARCHIVE="$ARTIFACT_ROOT/super-media-darwin-arm64.zip"
MANIFEST_CHECKSUM="$ARTIFACT_ROOT/super-media-darwin-arm64.manifest.sha256"
