...
const output = valueFor('--output', path.resolve('tmp/super-large-library'));
...
const child = spawn(process.execPath, [
  ...
  env: {
    ...process.env,
    SUPER_LARGE_LIBRARY_OUTPUT: path.resolve(output),
    SUPER_LARGE_LIBRARY_ASSETS: assets,
    SUPER_LARGE_LIBRARY_SEED: seed,
    SUPER_LARGE_LIBRARY_RESET: reset,
    SUPER_LARGE_LIBRARY_ASSET_PROFILE: assetProfile,
  },
  stdio: 'inherit',
});
