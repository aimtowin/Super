#!/usr/bin/env node
/**
 * Terminate orphaned Super dev processes (Electron + Forge) for this repo.
...
export function killStaleSuperDevProcesses(root = projectRoot) {
