/**
 * Pure helpers for audio asset detection (Super-0x5).
 ...
 * do not reuse this 4:3 cover in the inspect/view surface (Super-vlx).
 */
...
/**
 * Preview/grid cover stage — charcoal grey-black (Super-vlx).
 ...
 * preview (Super-vlx). Rejects near-white and pure black.
 */
...
/**
 * @deprecated Prefer `isDarkWaveformCoverBackground` (Super-vlx). Kept as an
