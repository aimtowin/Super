...
export const AUTOMATION_GATEWAY_ERROR_MESSAGES: Readonly<Record<AutomationGatewayErrorCode, string>> = {
  ...
  AUTOMATION_LIBRARY_NOT_OPEN: 'The requested library is not open in Super.',
  ...
  AUTOMATION_RESULT_INVALID: 'Super received an invalid result from the automation command.',
};
