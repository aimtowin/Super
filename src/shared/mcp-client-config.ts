...
/**
 * Pure client-config formatters (Super-8b5b.5). One canonical connection
...
export function buildMcpAgentConnectionText(
  ...
  return [
    ...
    '- Call super_library_list_open or super_library_list_recent to find a libraryId.',
    ...
    '- Keep this Bearer token secret. Revoke the client in Super settings when it is no longer trusted.',
  ].join('\n');
}
