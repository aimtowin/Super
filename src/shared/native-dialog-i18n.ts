/**
 * Native file-dialog / Main-process copy by app locale (Super-bwb).
 *
...
/** Map Electron `app.getLocale()` / BCP-47 tags to Super catalogs. */
...
export type NativeDialogId =
  ...
  /** macOS application picker for "Open With…" (Super-w29). */
  | "chooseApplication";
...
const EN: DialogCatalog = {
  ...
  openEagleLibraryDestination: {
    title: "Choose the parent folder for the new Super library",
