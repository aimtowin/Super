/**
 * Offscreen model-thumbnail render protocol (slice E, Super-hnmg).
 *
 ...
 * (super://source for source formats, super://preview for the FBX→GLB
...
export const modelThumbnailRenderRequestSchema = z.object({
  ...
  /** super://source/...?revision= or super://preview/<libraryId>/<artifactId>. */
 ...
 * renderer never re-enters the Worker through `super://source` while the
