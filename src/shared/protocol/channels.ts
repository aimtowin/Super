export const LIBRARY_REQUEST_CHANNEL = 'super:library:request' as const;
/** Renderer → Main: start an OS file drag during dragstart. */
export const ASSET_NATIVE_DRAG_CHANNEL = 'super:asset:native-drag' as const;
export const LIBRARY_LIFECYCLE_CHANNEL = 'super:library:lifecycle' as const;
export const ASSET_CHANGE_CHANNEL = 'super:asset:changed' as const;
export const LIBRARY_CHANGED_CHANNEL = 'super:library:changed' as const;
export const THUMBNAIL_CHANNEL = 'super:thumbnail' as const;
export const PROGRESS_CHANNEL = 'super:progress' as const;
export const AI_PROGRESS_CHANNEL = 'super:ai:progress' as const;
export const AI_COMPLETED_CHANNEL = 'super:ai:completed' as const;
export const AI_CLEARED_CHANNEL = 'super:ai:cleared' as const;

export const EXTENSION_SAVE_COMPLETED_CHANNEL =
  'super:extension:save-completed' as const;
export const ACTIVE_CONTEXT_CHANNEL = 'super:active-context' as const;
/** Renderer → Main: effective UI locale for native dialogs (Super-bwb). */
export const APP_LOCALE_CHANNEL = 'super:app-locale' as const;
 ...
 * structured result (Super-fmbr); the renderer shows the same toast as the
 * equivalent manual operation. Read-only and failed commands are not emitted.
 */
export const COMMAND_COMPLETED_CHANNEL = 'super:command:completed' as const;
export const REVEAL_APP_LOG_CHANNEL = 'super:shell:reveal-app-log' as const;
export const READ_APP_LOG_CHANNEL = 'super:shell:read-app-log' as const;
export const SHOW_EDIT_CONTEXT_MENU_CHANNEL =
  'super:shell:show-edit-context-menu' as const;
export const SHELL_SWIPE_CHANNEL = 'super:shell:swipe' as const;
export const WINDOW_CONTROL_CHANNEL = 'super:shell:window-control' as const;
/** Main → Renderer: trigger invert selection (macOS Edit menu, Super-te8p). */
export const INVERT_SELECTION_CHANNEL = 'super:shell:invert-selection' as const;
/** Main → Renderer: Edit Copy (⌘C) — file copy when assets selected (Super-166q). */
export const COPY_SELECTION_CHANNEL = 'super:shell:copy-selection' as const;
/** Main → Renderer: dispatch a native menu command through the app menu model. */
export const APPLICATION_MENU_COMMAND_CHANNEL =
  'super:shell:application-menu-command' as const;
/** Renderer → Main: sync a native menu item's enabled state (Super-q0b1). */
export const APPLICATION_MENU_ITEM_STATE_CHANNEL =
  'super:shell:application-menu-item-state' as const;
...
export const VIEWER_VIDEO_SHORTCUTS_ACTIVE_CHANNEL =
  'super:viewer:video-shortcuts-active' as const;
/** Main → Renderer: video letter shortcut (D/F/X/C) after before-input. */
export const VIEWER_VIDEO_SHORTCUT_CHANNEL =
  'super:viewer:video-shortcut' as const;
/** Main → Renderer: Windows F2 / Delete / Shift+Delete (Super-g8u9). */
export const BROWSE_SHORTCUT_CHANNEL =
  'super:shell:browse-shortcut' as const;
/** Renderer → Main: disable hidden F2/Delete accelerators in text fields. */
export const BROWSE_SHORTCUT_MENU_ENABLED_CHANNEL =
  'super:shell:browse-shortcut-menu-enabled' as const;

/** Renderer Desktop Console → Main-owned Automation Execution/Gateway bridge. */
export const AUTOMATION_SCRIPT_OPEN_CHANNEL = 'super:automation:script-open' as const;
export const AUTOMATION_SCRIPT_SAVE_CHANNEL = 'super:automation:script-save' as const;
export const AUTOMATION_SCRIPT_START_CHANNEL = 'super:automation:script-start' as const;
/** Renderer Desktop Console → Main: run an already Main-authorized execution. */
export const AUTOMATION_SCRIPT_EXECUTE_CHANNEL = 'super:automation:script-execute' as const;
export const AUTOMATION_SCRIPT_COMMAND_CHANNEL = 'super:automation:script-command' as const;
export const AUTOMATION_SCRIPT_COMPLETE_CHANNEL = 'super:automation:script-complete' as const;
export const AUTOMATION_SCRIPT_CANCEL_CHANNEL = 'super:automation:script-cancel' as const;
export const AUTOMATION_SCRIPT_HISTORY_CHANNEL = 'super:automation:script-history' as const;
export const AUTOMATION_SCRIPT_UNDO_CHANNEL = 'super:automation:script-undo' as const;
export const AUTOMATION_SCRIPT_RECENT_LIST_CHANNEL = 'super:automation:script-recent-list' as const;
export const AUTOMATION_SCRIPT_RECENT_OPEN_CHANNEL = 'super:automation:script-recent-open' as const;
/** Renderer ↔ Main: device-level embedded MCP service settings. */
export const MCP_SETTINGS_REQUEST_CHANNEL = 'super:mcp:settings-request' as const;
export const MCP_SETTINGS_EVENT_CHANNEL = 'super:mcp:settings-event' as const;
/** Critical confirmation child window: the preload exposes only these two calls. */
export const CRITICAL_CONFIRMATION_GET_CHANNEL = 'super:critical-confirmation:get' as const;
export const CRITICAL_CONFIRMATION_DECIDE_CHANNEL = 'super:critical-confirmation:decide' as const;
/** Renderer plugin manager → Main. File paths remain Main-owned. */
export const PLUGIN_MANAGER_CHANNEL = 'super:plugin-manager:request' as const;
/** Main → Renderer: progress and terminal state for a GitHub plugin install. */
export const PLUGIN_INSTALL_PROGRESS_CHANNEL = 'super:plugin:install-progress' as const;
/** Main → Renderer: plugin contributions changed after install/enable/refresh. */
export const PLUGIN_CONTRIBUTIONS_CHANGED_CHANNEL =
  'super:plugin:contributions-changed' as const;
/** Main → Renderer: active plugin input capture sessions for fan-in gating. */
export const PLUGIN_INPUT_CAPTURE_SESSIONS_CHANNEL =
  'super:plugin:input-capture-sessions' as const;
/** Renderer → Main: DOM input capture fan-in event. */
export const PLUGIN_INPUT_CAPTURE_EVENT_CHANNEL =
  'super:plugin:input-capture-event' as const;
/** Renderer → Main: system modal pause seam (dialogs outrank plugins). */
export const PLUGIN_INPUT_CAPTURE_SYSTEM_MODAL_CHANNEL =
  'super:plugin:input-capture-system-modal' as const;

/**
 * Offscreen model-thumbnail renderer channels (slice E, Super-hnmg).
...
export const OFFSCREEN_THUMBNAIL_RENDER_CHANNEL =
  'super:offscreen-thumbnail:render' as const;
