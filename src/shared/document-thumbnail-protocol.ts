/**
 * Offscreen document-thumbnail render protocol (Super-8ca259).
 *
 ...
 *
 * The request carries the HTML URL (super://source) and the viewport size.
...
export const documentThumbnailRenderRequestSchema = z.strictObject({
  ...
  /** super://source URL for the HTML asset. */
  url: z.string().min(1),
