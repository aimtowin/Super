/**
 * Per-session diagnostic logs (Super-wgmy).
 *
 * 每次启动写入 `super-<本地时间戳>.log`（如 super-20260816T221412.log），
 * 不再向单一 superApi.log 无限追加；磁盘上最多保留最近 MAX_SESSION_LOGS 份，
...
export const SESSION_LOG_PREFIX = 'super-';
 ...
 * 旧档案 superApi.log 不在命名空间内，本函数不触碰。
 */
