/**
 * Windows hidden Menu accelerators (VIEWER-018 + Super-g8u9).
 *
 ...
 * (Super-46i9 / znex). Browse items are disabled while the renderer reports
...
function rebuildWindowsAcceleratorMenu(): void {
  ...
  Menu.setApplicationMenu(
    Menu.buildFromTemplate([{ label: "Super", submenu }]),
  );
