...
export const PLUGIN_LIBRARY_DIRECTORY = '.super/plugins';
export const PLUGIN_LIBRARY_LOCK_FILE = '.super/plugin-lock.json';
export const PLUGIN_LIBRARY_SETTINGS_DIRECTORY = '.super/plugin-settings';
export const PLUGIN_LIBRARY_DATA_DIRECTORY = '.super/plugin-data';
