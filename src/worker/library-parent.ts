 ...
 * validating spinner (Super-sq4i). A filesystem root is a valid parent
 * (Super-qn6k); unwritable roots fail as PERMISSION_DENIED.
 */
 ...
 * Super library. Trailing separators from Windows folder pickers are stripped
