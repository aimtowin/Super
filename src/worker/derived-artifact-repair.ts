// Super-5xbg: derived-artifact repair for assets that failed generation.
//
...
// a real media-element error (Super-cljb).
// Super-140fe2: contact_sheet is excluded — failed sheets stay terminal and
...
export function requeueRetryableFailedArtifacts(
  ...
  // Super-verg.2 — lenient open (0031 §1): libraries predating the
