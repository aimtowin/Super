/**
 * Discrete browse-canvas card sizes (Super-7ny / CANVAS-018).
 *
 ...
 * Aligns with `VIEWER_WHEEL_MOUSE_NOTCH_THRESHOLD` (Super-fvpi).
 */
 ...
 * continuous high-gain path (Super-7ny).
 */
 ...
 *
 * Sensitivity (Super-7ny): higher gain + a modest |deltaY| floor that
 ...
 * notch is often |deltaY|≥100 and would jump many stops (Super-fvpi).
 ...
 * high-gain projection (Super-fvpi / Super-7ny).
 */
