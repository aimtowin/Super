/**
 * Pure folder keyboard target resolution (Super-vf8x).
 *
...
export function resolveFolderShortcutAction(
  ...
  // targeting. Delete goes to trash with no confirmation (Super-g8u9).
  if (focusedNav) {
  ...
  // Fallback: rename/trash the folder currently open in browse (Super-l0ow).
