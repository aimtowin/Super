...
export interface NavigationSidebarProps {
  ...
  // --- Internal asset drag/drop (REQ-DND-001/002 + Super-aa3 copy mode) ---
  ...
  /** Canvas/sidebar folder selection for folder drag (Super-nno6). */
...
export function NavigationSidebar(props: NavigationSidebarProps) {
  ...
  // Super-c42eb1: collection subtree collapse, mirroring folder collapse.
          ...
          onDragOver={(event) => {
            if (
              event.dataTransfer.types.includes(
                "application/x-super-managed-assets",
              )
            ) {
