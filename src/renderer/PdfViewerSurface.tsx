...
/**
 * Super-8ca259: PDF viewer that renders every page into a vertical,
 ...
 *
 * Zoom/pan follows the image/video viewer interaction model (Super 工单):
...
export function PdfViewerSurface({
  ...
  //
  // `super://` is intentionally not an http(s) URL. pdf.js therefore falls
  ...
  useEffect(() => {
    ...
    const layoutNode = (element: HTMLElement, size: PdfPageSize) => {
      ...
      // zoomed pages overflow and unlocks horizontal scrolling (Super P2).
      ...
      try {
        ...
        const renderPage = async (pageNumber: number) => {
          ...
          try {
            ...
            // crisp bitmap is ready (Super P2: no white flash on zoom).
