...
// ---------------------------------------------------------------------------
// Nav tree collapse preferences (CU-D2 / Super-5n5)
// ---------------------------------------------------------------------------
...
export interface NavTreePreferences {
  ...
  /**
   * Collection ids whose child collections are hidden (Super-c42eb1).
...
export const NAV_TREE_PREF_KEY = "superApi.nav-tree-prefs.v1";
