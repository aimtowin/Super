 ...
 * Tiny cards hide all badges (Super-7zt).
 *
 * Layout (Super-i07 / CANVAS-025):
 ...
 * Model cards carry the "3D" chip exactly like VIDEO/TEXT (Super-fu2i);
...
/**
 * Bottom-right extension chip for non-image assets (Super-i07).
