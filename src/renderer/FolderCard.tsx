...
interface FolderCardProps {
  ...
  libraryId: string;
  selected: boolean;
  /** REQ-DND-006 / Super-12mb: external file drop target highlight. */
  dropActive?: boolean;
  ...
  /** Trash tombstone card; double-click enters hierarchy (Super-6pcd). */
  trashed?: boolean;
}

/**
 * Direct child folder card on the browse canvas (REQ-FOLDER-001/010 / Super-l67w).
            ...
            {coverArtifactId === null ? (
              ...
              <div className="folder-card-cover-photo">
                <img
                  ...
                  // Super-d0nv: the folder-card row is a bounded, first-screen
