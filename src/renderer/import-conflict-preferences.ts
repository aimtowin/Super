...
/**
 * Remembered import conflict decisions (Super-9iyi / gf8n / zp8q).
...
export const IMPORT_CONFLICT_PREF_KEY = 'superApi.import-conflict.v1';
...
export function loadImportConflictPreferences(
  ...
  try {
    ...
    // Super-9h01: merge removed from UI — treat remembered merge as create-copy.
