 ...
 * resolved to `zh-CN` or `en`. E2E injects `__SUPER_E2E_LOCALE__` via preload
...
export const LOCALE_PREF_KEY = 'superApi.locale-prefs.v1';
...
export function readSystemLocale(
  ...
  const e2eLocale = (
    globalThis as { __SUPER_E2E_LOCALE__?: string }
  ).__SUPER_E2E_LOCALE__;
