...
export const en = {
  ...
  shell: {
    ...
    networkStorageNotice:
      "This library is on a network share (NAS/SMB). Super uses rollback journaling here; file locking and disconnect recovery depend on the NAS. Keep one Super instance writing at a time and maintain backups.",
    readOnlyBanner:
      "This library is read-only because it was created by a newer version of Super. Upgrade Super to edit it.",
    readOnlyBannerMigrationStuck:
      "This library could not be migrated after repeated attempts and is now read-only. Keep this version of Super installed and try upgrading once it is available.",
    readOnlyBannerVersioned:
      "This library was created by Super v{libraryVersion} (this build supports v{supportedVersion}). It is open in read-only mode. Upgrade Super to edit it.",
    ...
    recoveryReadonly: "The library database is damaged. Super opened it read-only so its remaining data can be copied out.",
    ...
    recoveryReportAvailable: "A recovery report was saved under the library's .super/corrupt-backup folder.",
  ...
  automation: {
    preview: {
      ...
      fileErrors: {
        ...
        "invalid-script-file": "Choose a .superApi.js or .superApi.ts script file.",
  ...
  filter: {
    ...
    palette: "Palette",
    paletteSelected: "{count} selected",
    paletteSelectHint: "Click to select · Shift for more",
    color: {
      red: "Red",
      scarlet: "Scarlet",
      orange: "Orange",
  ...
  command: {
    ...
    folder: {
      ...
      addLinkedFolderToCollection: "Add folder assets to collection…",
      moveToTrash: "Move to Trash",
      deleteFromDisk: "Delete from disk…",
  ...
  dialog: {
    ...
    openEagleLibrary: {
      ...
      body: "Convert the selected Eagle library into a new Super library.",
      name: "Name",
      help: "",
    ...
    openBillfishLibrary: {
      ...
      body: "Convert the selected Billfish library into a Super library.",
      name: "Name",
      help: "",
      submit: "Choose save location"
    },
    ...
    restore: {
      ...
      nameConflict: "Name conflicts",
      replaceHelp: "Replace deletes the conflicting asset’s Super record and managed files. The restored asset keeps its original ID and metadata.",
    ...
    undoMove: {
      ...
      skip: "Skip conflicting assets",
      help: "Super did not overwrite the original location. Choose an explicit conflict strategy before undoing.",
    ...
    imageSequence: {
      ...
      fps: "Frame rate (FPS)",
      help: "Choose 1–240 FPS. This only changes browsing and playback in Super; source images are untouched.",
    ...
    linkedFolderCollection: {
      title: "Add \"{name}\" to collection",
      cancelAria: "Cancel adding to collection",
      help: "Adds the currently available, unfiltered linked assets to a collection.",
      target: "Target collection",
      targetPlaceholder: "Select a collection",
      includeSubfolders: "Include assets in subfolders",
      snapshotNotice: "This is a one-time membership snapshot: later source-folder additions, removals, or moves do not sync the collection. Source files are not copied.",
    ...
    mediaJobs: {
      ...
      linkedRemovalSection: "Linked library removal",
      linkedRemovalSummary: "{name} · {removed}/{total} removed · {status}",
      pauseLinkedRemoval: "Pause",
      resumeLinkedRemoval: "Resume",
      linkedIndexSection: "Linked library indexing",
      linkedIndexSummary: "{indexed} indexed · {scanned} directories scanned · {pending} remaining · {status}",
      pauseLinkedIndex: "Pause",
      resumeLinkedIndex: "Resume",
    ...
    about: {
      ...
      description: "A free, open local asset library for files, tags, collections, and previews.",
      openSourceNote: "Found an issue or want to help? Feedback is welcome on GitHub.",
      checkForUpdates: "Check for updates",
      downloadAndInstall: "Download and install update",
      cancelDownload: "Cancel download",
      updateNotChecked: "Check for a newer version of Super.",
    ...
    openSource: {
      ...
      subtitle: "The main open-source projects Super relies on and what they do.",
    ...
    importLibraryChooser: {
      title: "Import library",
      help: "Import from a library folder or an exported ZIP, or open an Eagle library as a new Super library.",
    ...
    openLibraryChooser: {
      title: "Open library",
      help: "Open an existing Super library, pull one from a sync server, or convert Eagle / Billfish into a new Super library.",
      super: "Open Super library",
      external: "Open external library"
    }
  },
  aiConfig: {
  ...
  /** REQ-PREF-001 / Super-9es: file name / size / date share one cardFieldsHint. */
  plugin: {
  ...
  settings: {
    ...
    pluginThemeTrustedCssHint: "This plugin may inject custom CSS into the Super host UI. Host CSS can break layout, accessibility, and upgrade compatibility.",
    pluginThemeTrustedCssTrustHint: "Host CSS in non-restricted mode can modify the Super interface outside plugin iframes. Only trust plugins whose styling changes you accept.",
    ...
    pluginHostSettingsHint: "Host-rendered settings from the plugin manifest. Values persist across library reopen; active plugins can read mirrored values via Super.storage.get('settings.<id>').",
    ...
    backgroundUseDefault: "Use default background",
    backgroundRestoreDefault: "Restore default background",
    backgroundBuiltInImage: "Built-in default · anime theme",
    backgroundOpacity: "Opacity",
    appFontSizeSection: "App font size",
    appFontSizeHint: "Changes only Super Lib text. System scaling, browser zoom, and other apps are unaffected.",
    appFontSizeLevel1: "1 Small",
    appFontSizeLevel2: "2 Standard",
    appFontSizeLevel3: "3 Large",
    appFontSizeLevel4: "4 Largest",
    ...
    themePreviewAuthorValue: "Super Studio",
    ...
    browserExtensionIntro:
      "Save web images and videos into the active library with the Chrome / Edge extension. Media is downloaded by the browser (with cookies and the page Referer) and uploaded to this machine, bypassing most hotlink protections. Keep Super running with a library open.",
    browserExtensionDownload: "Go to downloads",
    browserExtensionStepDownload:
      "Click “Go to downloads” to open the release page and download the file for your browser: Super-extension-<version>.zip for Chrome/Edge, Super-extension-firefox-<version>-signed.xpi for Firefox.",
    browserExtensionStepExtract:
      "Chrome / Edge: extract the zip to a fixed folder (e.g. Documents/Super-extension). The folder must directly contain manifest.json.",
    ...
    mcpIntroHint: "Allow MCP clients to control this running Super desktop through a loopback-only Streamable HTTP endpoint.",
    ...
    mcpAutoStartHint: "Start the loopback server when Super opens.",
    ...
    mcpAgentHandoffHint: "Click “Copy for Agent”, then paste the clipboard text into your Agent to connect and control Super.",
    mcpRevoke: "Revoke",
    mcpRevoked: "Revoked",
    ...
    sync: {
      ...
      webdavUrlHint: "Any server subpath works, e.g. https://nas.local/dav/share/Super/; http:// is added automatically when omitted.",
      ...
      serversHint: "Add, test, and manage global WebDAV servers. A server address may include a path (e.g. …/Share/Super); each library is placed under it as a folder named after the library.",
  ...
  preview: {
    ffmpegRequired: "This install is missing the media component needed for a video playback proxy. Reinstall or repair Super and try again.",
  ...
  toast: {
    bridgeUnavailable: "Cannot connect to the Super desktop service. Please restart the app.",
    ...
    linkedFolderAddedToCollection: "Added {count} linked assets to the collection (future changes do not sync automatically).",
    linkedFolderAddToCollectionFailed: "Could not add linked-folder assets to the collection.",
    ...
    linkedFolderRemovalQueued: "Started removing the index for \"{name}\" ({count} items). View, pause, or resume it in Background Media Tasks; the source folder is unchanged.",
    ...
    sourceUrlOpenUnauthorized: "Cannot open the source URL from this window. Reload Super and try again.",
  ...
  error: {
    code: {
      ...
      INTERNAL_ERROR: "Super hit an unexpected error and could not finish. Open Diagnostics to inspect this session’s log, then retry. If you were opening a library, copy the whole library folder onto a local disk and open it from there.",
      ...
      WEB_MEDIA_DROP_TOO_LARGE: "Web drop metadata is too large; Super refused to parse it.",
      ...
      LIBRARY_NOT_FOUND: "Super cannot find that library folder. It may have been moved, renamed, or the disk may be disconnected. Reconnect the drive or choose the library again from Open Library.",
      NOT_A_LIBRARY: "The selected folder is not a Super library (it has no .super database).",
      LIBRARY_CORRUPT: "Super could not read this library’s database (integrity check or migration history failed). Reopen the library so Super can restore from a backup. Copy the whole library folder to a local disk first if you want a safety copy.",
      LIBRARY_ENGINE_UNAVAILABLE: "Super could not load its SQLite database engine. This is an application install problem, not damage to your library files. Reinstall Super or rebuild native modules; do not restore backups or delete the library folder.",
      LIBRARY_VERSION_TOO_NEW: "This library was created by a newer version of Super, so this app cannot open it. Install the latest Super, then open the library again.",
      LIBRARY_READ_ONLY: "Super cannot write to this library because the files are locked or marked read-only. Clear the read-only flag, close other programs using the folder, and retry.",
      ...
      LIBRARY_MIGRATION_STUCK: "This library could not be migrated after repeated attempts. Super opened it at the last working schema so you can keep using it. Upgrade Super when a fix is available; do not delete the library folder.",
      LIBRARY_STRUCTURE_MISMATCH: "This library’s database structure does not match this version of Super. Upgrade to the latest Super and reopen the library.",
      LIBRARY_NOT_WRITABLE: "Super could not write files in the selected folder. The folder may lack write permission, the disk may be full or read-only, or another program may have the files locked. Check the folder and NAS connection, then retry.",
      LIBRARY_NETWORK_SHARE: "Super could not open or write the library database on this network share (NAS/SMB). NAS libraries use rollback journaling and depend on the share’s file-locking and reconnect behavior. Check the NAS connection and permissions; if it keeps failing, copy the library to a local disk or use WebDAV sync.",
      LIBRARY_IO_ERROR: "Super could not complete the library operation because the disk or filesystem reported an I/O error. Check the drive connection, free space, and permissions; if it keeps failing, copy the library to a local disk and inspect Diagnostics.",
      ...
      LIBRARY_CLEANUP_FAILED: "Creating the library failed, and leftover temporary files could not be removed automatically. Delete any `.super-create-*.partial` folder next to the chosen location, then retry with a writable folder.",
      ...
      ASSET_MOVE_CONFLICT: "Asset move could not complete: the source or destination changed. Super did not overwrite silently.",
      ...
      SYNC_CONNECTION_FAILED: "Super could not reach the sync server. Check the address, username, password, and that the computer is online. Follow the more specific reason when Super can classify the failure.",
    ...
    reason: {
      ...
      SOURCE_TRASH_FAILED: "The OS refused to move the source file to the system Trash; both the source file and the Super record were kept.",
      ...
      NOT_A_LIBRARY: "The selected destination is not a valid Super library.",
      ...
      AI_RATE_LIMIT: "Too many requests; Super will retry later.",
      AI_NETWORK: "Could not reach the AI provider. Check the network.",
      AI_TIMEOUT: "AI request timed out; Super will retry later.",
      ...
      CONTACT_SHEET_REQUIRED: "Video contact sheet/poster is not ready yet; Super will retry automatically.",
      ...
      LIBRARY_PARENT_INSIDE_SOURCE: "The new Super library cannot be saved inside the Eagle/Billfish source. Choose a folder outside the source library.",
