 ...
 *   Exception (Super-4kg3): when the delta is primarily horizontal,
 ...
 * slide rather than a pinch / vertical zoom chord (Super-4kg3).
...
export function classifyViewerWheel(
  ...
  if (sample.ctrlKey || sample.metaKey) {
    ...
    // horizontal two-finger slide with ctrlKey (Super-4kg3).
...
/**
 * Zoom anchor for one wheel gesture (Super-yo0n, 2026-07-20 user ruling):
