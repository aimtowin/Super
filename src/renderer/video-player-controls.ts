/**
 * Pure helpers for the asset viewer video player (REQ-VIEW-005 / Super-60k).
 *
 ...
 * tried first (Super-2j9) and failed human acceptance: the browser's own
 ...
 * still work after the rate control was clicked (VIEWER-018 / Super-gwp1).
 */
...
/** Ctrl+← / Ctrl+→ skip distance (Super-sk1). */
...
/**
 * D = previous frame, F = next frame (Super-soii);
 * Ctrl+←/→ = ±2s.
...
/**
 * X = slower, C = faster — step within VIDEO_PLAYBACK_RATES (Super-soii).
 */
