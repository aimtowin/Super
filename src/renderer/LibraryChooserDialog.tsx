...
export interface ImportLibraryChooserDialogProps {
  ...
  onImportFolder: () => void;
  onImportZip: () => void;
  /** Convert an Eagle library into a new Super library (open, not merge). */
  onOpenEagle?: () => void;
  /** Merge an Eagle library into the currently open Super library. */
  onImportEagle?: () => void;
  onOpenBillfish?: () => void;
...
/**
 * Menu 「打开资源库」chooser (Super-pte2 / Super-7zp0): existing Super
      ...
      >
        ...
        <div className="dialog-actions is-stacked">
          ...
          >
            ...
            {t("dialog.openLibraryChooser.super")}
          </button>
          {onOpenSyncLibrary ? (
            <button
              className="secondary-button"
