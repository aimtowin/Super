/** Super-sa65: page math and real-summary merging for virtualized browse. */
...
/** First-paint Inspector/card copy from the compact layout index (Super-l2at / Super-joz6). */
