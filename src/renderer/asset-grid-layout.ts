 ...
 * white slice (Super-1s3d). Stable shortest-column packing keeps the
 * columns visually balanced while the original asset array remains the
 * selection/browse order (Super-1jnp / SELECT-014).
 *
...
/**
 * Shift-range ids for masonry: identical to asset array order (Super-1jnp).
 ...
 * baselines every frame at 125%/150% DPI (Super-oq86).
 */
 ...
 * ratios, fill the container width (REQ-CANVAS-004 / Super-8nj).
 */
