...
/** @deprecated Caption no longer flex-couples to preview height (Super-5p45). */
 ...
 * flex-shrink the media box (Super-omn / Super-5p45).
 */
...
export function JustifiedAssetRows({
   ...
   * caption renders at natural height below (Super-5p45).
   */
