/**
 * Apply a saved browser session after library open (Super-uye extract).
...
export type RestoreBrowserSessionDeps = {
  ...
  /**
   * Super-ws4k: register the restored scope with the pagination controller
 ...
 * scope query / filename search when the asset is missing (Super-6w7n).
 */
