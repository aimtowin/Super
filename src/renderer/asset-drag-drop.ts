// ---------------------------------------------------------------------------
// Asset drag & drop (REQ-DND-001/002 + Super-aa3 copy mode)
//
...
// managed files via copyAssets (Super-2vn); collection drops are always
// membership-add for both move and copy (never remove from a source folder
// or source collection on sidebar drop).
// ---------------------------------------------------------------------------

export const MANAGED_ASSETS_DRAG_TYPE = 'application/x-super-managed-assets';
...
/** Platform-correct modifier name for copy-mode toasts (Super-2vn). */
...
/** Assets eligible for the Super trash: linked files stay outside the trash. */
 ...
 * for the result toast. Linked assets never enter the Super trash.
