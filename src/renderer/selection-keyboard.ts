/**
 * Browse-canvas selection chords (Super-5fq + Escape clear).
 *
...
/** Invert selection among visible assets: ⌘I / Ctrl+I (Super-5fq). */
 ...
 * select-all/invert are no-ops on an empty scope (Super-ws4k — the async
