...
export const THEME_PROFILE_PREF_KEY = 'superApi.theme-profile.v3';
/** v2 persisted key: four fixed presets (vscode-dark/super-dark/super-light/soft-light). */
export const THEME_PROFILE_LEGACY_KEY = 'superApi.theme-profile.v2';

export const THEME_PROFILE_IDS = ['super', 'vscode', 'soft'] as const;
...
> = {
  super: {
    id: 'super',
    label: 'Super',
    tokens: { dark: superDark, light: superLight },
  },
  vscode: {
    id: 'vscode',
    label: 'VS Code',
