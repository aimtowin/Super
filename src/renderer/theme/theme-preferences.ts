 ...
 * resolved to `light` or `dark`. E2E injects `__SUPER_E2E_THEME__` via
...
export const THEME_PREF_KEY = 'superApi.theme-prefs.v1';
...
export function readSystemTheme(
  ...
  const e2eTheme = (
    globalThis as { __SUPER_E2E_THEME__?: string }
  ).__SUPER_E2E_THEME__;
