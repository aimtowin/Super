...
/**
 * User accent color preference (REQ-THEME-005 / Super-qw6x / THEME-018).
 * Writes only `--accent` on :root; CSS color-mix derives soft/ring/dark/soft-fg.
 */

export const ACCENT_PREF_KEY = 'superApi.accent-prefs.v1';
 ...
 * CSS color-mix derivatives stay in sync (Super-gnus).
 */
