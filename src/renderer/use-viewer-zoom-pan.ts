 ...
 * video — Super-yo0n / Super-190). Owns the viewport ref, the wheel
...
export function useViewerZoomPan({
  ...
  // Cmd/Ctrl+=|-|0: zoom at viewport center; 0 = fit (Super-46i9).
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const onWheel = (event: WheelEvent) => {
      ...
      if (
        ...
        // (Super-yo0n): mid-gesture pointer drift must not move it.
