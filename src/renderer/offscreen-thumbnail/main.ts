/**
 * Offscreen thumbnail page entry (slice E, Super-hnmg).
 *
...
declare global {
  interface Window {
    ...
    __superOffscreenThumbnailDebug?: {
...
window.__superOffscreenThumbnailDebug = { requestId: null, stage: 'booting' };
...
window.__superOffscreenThumbnailDebug.stage = 'bridge-ready';
...
bridge.onRender((job) => {
  window.__superOffscreenThumbnailDebug = {
