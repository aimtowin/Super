/**
 * Browse-canvas infinite scroll helpers (Super-r94b).
 *
 ...
 * present (Super-ws4k). The page is a strict continuation of the previous
 ...
 * (Super-关联刷新). Without this, an append page that was fetched before the
