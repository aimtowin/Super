...
/**
 * Fully custom chrome around `HTMLVideoElement` (REQ-VIEW-005 / Super-60k):
 * - Space play/pause when the viewer is focused (not in text fields)
 * - D / F frame step (D=back, F=forward) and Ctrl+←/→ ±2s skip (Super-sk1 / soii)
 * - X / C step playback rate within VIDEO_PLAYBACK_RATES (Super-soii)
 ...
 * on every pointermove (Super-jh2).
 */
export function VideoPlayerControls({
  ...
  useEffect(() => {
    const shell = (window as RendererWindow).super?.shell;
