...
// Super hover-play anti-mistouch: fast scrolling across cards must not
...
export function useAssetCardHoverPreview(input: {
  api: SuperLibraryApi | null | undefined;
   ...
   * (Super-c8a1a3). Same rule as the viewer: a proxy is only created after
  ...
  // super://source URL when two libraries contain the same asset id, and
