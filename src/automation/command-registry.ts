...
export const automationCapabilityRegistry = [
  ...
  },
  {
    ...
    displayName: '修改资产内容',
    description: '替换、暂存或修改受 Super 管理的资产文件。',
    riskTier: 'controlled',
    defaultPolicy: 'ask',
    canPersist: true,
  },
  ...
  },
  {
    ...
    displayName: '重命名文件',
    description: '重命名受 Super 管理的资产文件。',
    riskTier: 'controlled',
    defaultPolicy: 'ask',
    canPersist: true,
  },
  {
    ...
    displayName: '移入回收站',
    description: '将资产移入 Super 回收站，以便后续恢复或清理。',
    riskTier: 'controlled',
    defaultPolicy: 'ask',
    canPersist: true,
  },
  ...
  },
  {
    ...
    displayName: '向桌面显示提示',
    description: '在 Super 桌面显示受限的信息提示。',
    riskTier: 'safe',
    defaultPolicy: 'allow',
    canPersist: false,
  },
...
export const automationCommandInputSchemas = {
  ...
  'ui.notify': z.strictObject({
    ...
    // Super review: the accepted stateless design keeps ui.notify strictly
...
export interface AutomationCommandDescriptor<Id extends AutomationCommandId = AutomationCommandId> {
  ...
  /** Super-8b5b.2: the command is dangerous — MCP calls require the two-phase agent challenge. */
...
export const automationCommandRegistry = [
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_asset_metadata_set_many', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_library_list_open', outputLimit: 1 },
    libraryContext: 'none',
    toWorkerCommand: () => {
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_library_open', outputLimit: 1 },
    libraryContext: 'transition',
    toWorkerCommand: () => {
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_library_show_in_desktop', outputLimit: 1 },
    libraryContext: 'transition',
    toWorkerCommand: () => {
  ...
  readDescriptor({
    ...
    mcp: { public: true, toolName: 'super_library_list_recent', outputLimit: 64 }, libraryContext: 'none',
  ...
  }),
  {
    ...
    atomicity: 'single-transaction', approvalPolicy: 'execution', mcp: { public: true, toolName: 'super_library_close', outputLimit: 1 },
  ...
  },
  {
    ...
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false,
    atomicity: 'single-transaction', approvalPolicy: 'execution', mcp: { public: true, toolName: 'super_library_rename', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'best-effort', approvalPolicy: 'none', criticalOperation: true, mcp: { public: true, toolName: 'super_library_delete_from_disk', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation', approvalPolicy: 'execution', mcp: { public: true, toolName: 'super_library_export', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation', approvalPolicy: 'execution', mcp: { public: true, toolName: 'super_library_import_folder', outputLimit: 1 },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.create'], allowedSources: allInteractiveSources, impact: 'file-write', targetScope: 'library', libraryContext: 'none', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: true, supportsUndo: false,
    atomicity: 'recoverable-file-operation', approvalPolicy: 'execution', mcp: { public: true, toolName: 'super_library_import_zip', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_library_inspect', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_library_change_sequence', outputLimit: 1 },
    libraryContext: 'active',
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_execution_status', outputLimit: 1 },
    libraryContext: 'none',
    toWorkerCommand: () => {
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_history_status', outputLimit: 1 },
    libraryContext: 'active',
  ...
  }),
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_history_undo', outputLimit: 1 },
    libraryContext: 'active',
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_history_redo', outputLimit: 1 },
    libraryContext: 'active',
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_ui_notify', outputLimit: 1 },
    libraryContext: 'none',
    toWorkerCommand: () => {
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_asset_rating_set', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  },
  {
    ...
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_asset_paths_copy', outputLimit: 1 },
  ...
  },
  {
    ...
    apiVersion: AUTOMATION_API_VERSION,
    summary: '将托管资产移入 Super 回收站；不会永久删除文件。',
    deprecated: false,
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_trash', outputLimit: 1 },
  ...
  {
    // Super-8b5b.2: the first MCP-exposed dangerous command. It is MCP-only
    ...
    mcp: { public: false, toolName: 'super_asset_delete_permanent', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_content_replace', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'best-effort',
    approvalPolicy: 'none',
    mcp: { public: false, toolName: 'super_asset_content_stage', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_content_replace_batch', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    targetScope: 'asset',
    supportsBatch: false,
    mcp: { public: false, toolName: 'super_asset_content_read', outputLimit: 1 },
  ...
  }),
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_move', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_rename_file', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_rename_files', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: false, toolName: 'super_asset_list_trash', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    atomicity: 'recoverable-file-operation',
    approvalPolicy: 'plan',
    mcp: { public: false, toolName: 'super_asset_restore_if_original_vacant', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: false, toolName: 'super_asset_palette_aggregate_recent', outputLimit: 24 },
    toWorkerCommand: (libraryId, input) => ({
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_folder_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_folder_create', outputLimit: 1 },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_folder_rename', outputLimit: 1 },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_folder_move', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_folder_delete_empty', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_linked_folder_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    mcp: { public: true, toolName: 'super_linked_folder_create', outputLimit: 1 },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'folder.write'], allowedSources: allInteractiveSources, impact: 'file-write', targetScope: 'library', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: true, supportsUndo: false, atomicity: 'recoverable-file-operation', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_linked_folder_relink', outputLimit: 1 },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_linked_folder_remove', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    mcp: { public: true, toolName: 'super_linked_folder_rules_get', outputLimit: 200 },
  ...
  }),
  {
    ...
    requiredCapabilities: ['library.read', 'folder.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_linked_folder_rules_set', outputLimit: 200 },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_linked_folder_refresh', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: true,
    mcp: { public: true, toolName: 'super_asset_list', outputLimit: 200 },
    toWorkerCommand: (libraryId, input) => ({
      type: 'asset.list',
      libraryId,
  ...
  }),
  {
    ...
    mcp: { public: true, toolName: 'super_asset_copy', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    mcp: { public: true, toolName: 'super_asset_thumbnail_get', outputLimit: 1 },
  ...
  }),
  {
    ...
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: true, supportsUndo: false, atomicity: 'best-effort', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_asset_preview_get', outputLimit: 1 },
  ...
  },
  {
    ...
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: true, supportsUndo: false, atomicity: 'best-effort', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_asset_refresh', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
    toWorkerCommand: (libraryId) => ({ type: 'asset.refresh', libraryId }),
    projectResult: (result) => { const parsed = assetRefreshedWorkerResultSchema.safeParse(result); return parsed.success ? { changedCount: parsed.data.changedCount, missingCount: parsed.data.missingCount, assets: parsed.data.assets } : undefined; },
  },
  readDescriptor({
    ...
    targetScope: 'asset',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_asset_metadata_get', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    targetScope: 'asset',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_asset_ai_content_get', outputLimit: 1 },
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_asset_metadata_set', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    targetScope: 'asset',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_asset_extracted_metadata_get', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: true,
    mcp: { public: true, toolName: 'super_asset_search', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
    toWorkerCommand: (libraryId, input) => ({
      type: 'asset.search',
      libraryId,
      query: input.query,
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_tag_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_tag_create', outputLimit: 1 },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_tag_rename', outputLimit: 1 },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'tag.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'tag-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_tag_delete', outputLimit: 1 },
  ...
  },
  {
    ...
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'tag-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_tag_delete_many', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'tag.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: true,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'tag-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_tag_merge', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    mcp: { public: true, toolName: 'super_tag_cooccurrence', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_tag_assign', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  },
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_tag_remove', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_collection_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_collection_create', outputLimit: 1 },
  ...
  },
  {
    ...
    mcp: { public: true, toolName: 'super_collection_update', outputLimit: 1 },
  ...
  },
  {
    ...
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'collection-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_collection_reorder', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'collection.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'collection-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_collection_delete', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_collection_assets_add', outputLimit: 1 },
  ...
  },
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_collection_assets_remove', outputLimit: 1 },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'collection.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: true,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'collection-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_collection_assets_reorder', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    mcp: { public: true, toolName: 'super_collection_assets_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    targetScope: 'asset-set',
    supportsBatch: true,
    mcp: { public: true, toolName: 'super_collection_asset_memberships', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
    toWorkerCommand: (libraryId, input) => ({
  ...
  readDescriptor({
    ...
    targetScope: 'library',
    supportsBatch: false,
    mcp: { public: true, toolName: 'super_smart_collection_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    mcp: { public: true, toolName: 'super_smart_collection_create', outputLimit: 1 },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'collection.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'smart-collection-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_smart_collection_update', outputLimit: 1 },
  ...
  },
  {
    ...
    requiredCapabilities: ['library.read', 'collection.write'], allowedSources: allInteractiveSources, impact: 'metadata-write', targetScope: 'library', supportsBatch: false,
    supportsDryRun: false, supportsIdempotencyKey: false, supportsCancellation: false, supportsDetach: false, supportsUndo: false, history: { policy: 'reversible', recipeKind: 'smart-collection-snapshot', group: 'single-command' }, atomicity: 'single-transaction', approvalPolicy: 'execution',
    mcp: { public: true, toolName: 'super_smart_collection_delete', outputLimit: 1 },
  ...
  readDescriptor({
    ...
    requiredCapabilities: ['library.read', 'asset.read', 'collection.read'], allowedSources: allReadSources, targetScope: 'library', supportsBatch: false,
    mcp: { public: true, toolName: 'super_smart_collection_execute', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    supportsBatch: true,
    supportsDetach: true,
    mcp: { public: true, toolName: 'super_media_jobs_list', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  readDescriptor({
    ...
    supportsBatch: true,
    supportsDetach: true,
    mcp: { public: true, toolName: 'super_media_jobs_cancel', outputLimit: 1 },
    toWorkerCommand: (libraryId, input) => ({
  ...
  readDescriptor({
    ...
    supportsBatch: true,
    supportsDetach: true,
    mcp: { public: true, toolName: 'super_ai_jobs_status', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
  ...
  }),
  {
    ...
    atomicity: 'single-transaction',
    approvalPolicy: 'execution',
    mcp: { public: false, toolName: 'super_ai_enqueue', outputLimit: AUTOMATION_MAX_PAGE_SIZE },
...
export function getAutomationCommandPermissionMetadata(
  ...
  // Super-8b5b.2: critical commands are gated by the two-phase agent
...
export function generateAutomationTypeDeclaration(
  _moduleSpecifier = '@super/automation',
): string {
  ...
  return [
    ...
    '  }',
    '',
    '  interface SuperScriptAssetSearchPage {',
    '    readonly items: readonly SuperScriptAsset[];',
    ...
    '  }',
    '',
    '  interface SuperScriptFolder {',
    '    readonly id: string;',
    '    readonly parentId: string | null;',
    '    readonly name: string;',
    '  }',
    '',
    '  interface SuperScriptFolderPage {',
    '    readonly items: readonly SuperScriptFolder[];',
    '    readonly total: number;',
    '    readonly offset: number;',
    '    readonly limit: number;',
    '    readonly hasMore: boolean;',
    '  }',
    '',
    '  interface SuperScriptLibrary {',
    '    readonly id: string;',
    '    readonly displayName: string;',
    '  }',
    '',
    '  interface SuperScriptImportResult {',
    ...
    '    readonly completion?: { readonly importedCount: number; readonly fileCount: number; readonly assetCount: number; readonly skippedCount: number; readonly replacedCount: number; readonly assets: readonly SuperScriptAsset[] };',
    '  }',
    '',
    '  interface SuperScriptTag {',
    '    readonly id: string;',
    '    readonly name: string;',
    '    readonly assetCount: number;',
    '  }',
    '',
    '  interface SuperScriptTagPage {',
    '    readonly items: readonly SuperScriptTag[];',
    '    readonly total: number;',
    '    readonly offset: number;',
    '    readonly limit: number;',
    '    readonly hasMore: boolean;',
    '  }',
    '',
    '  interface SuperTagMutationResult {',
    '    readonly assignedCount?: number;',
    '    readonly removedCount?: number;',
    '    readonly skipped: readonly { readonly assetId: string; readonly reason: string }[];',
    '  }',
    '',
    '  interface SuperScriptCollection {',
    '    readonly id: string;',
    '    readonly parentId: string | null;',
    '    readonly name: string;',
    '    readonly description: string | null;',
    ...
    '  }',
    '',
    '  interface SuperScriptSmartCollection {',
    '    readonly id: string;',
    '    readonly name: string;',
    ...
    '  }',
    '',
    '  interface SuperScriptLinkedFolder {',
    '    readonly id: string;',
    '    readonly name: string;',
    ...
    '  }',
    '',
    '  interface SuperScriptExtractedMetadata {',
    '    readonly assetId: string;',
    ...
    '  }',
    '',
    '  interface SuperAutomationApi {',
    '    readonly library: {',
    '      inspect(): Promise<SuperScriptLibrary>;',
    ...
    '    };',
    '    readonly files: {',
    `      import(input: { sourceKind: 'files' | 'folder'; sourcePaths: readonly string[]; targetFolderId?: string; imageSequenceFps?: number; expandImageSequences?: boolean; idempotencyKey?: string }): Promise<SuperScriptImportResult>;`,
    '    };',
    '    readonly folders: {',
    '      list(input?: { limit?: number; offset?: number }): Promise<SuperScriptFolderPage>;',
    '      create(name: string, parentFolderId?: string | null): Promise<SuperScriptFolder>;',
    '    };',
    '    readonly linkedFolders: {',
    '      list(input?: { limit?: number; offset?: number }): Promise<{',
    '        readonly items: readonly SuperScriptLinkedFolder[];',
    '        readonly total: number; readonly offset: number; readonly limit: number; readonly hasMore: boolean;',
    '      }>;',
    '    };',
    '    readonly tags: {',
    '      list(input?: { limit?: number; offset?: number }): Promise<SuperScriptTagPage>;',
    '      create(name: string): Promise<SuperScriptTag>;',
    '      assign(assetIds: readonly string[], tagIds: readonly string[]): Promise<SuperTagMutationResult>;',
    '      remove(assetIds: readonly string[], tagIds: readonly string[]): Promise<SuperTagMutationResult>;',
    '    };',
    '    readonly collections: {',
    '      list(input?: { limit?: number; offset?: number }): Promise<{',
    '        readonly items: readonly SuperScriptCollection[];',
    '        readonly total: number; readonly offset: number; readonly limit: number; readonly hasMore: boolean;',
    '      }>;',
    ...
    '      list(input?: { limit?: number; offset?: number }): Promise<{',
    '        readonly items: readonly SuperScriptSmartCollection[];',
    '        readonly total: number; readonly offset: number; readonly limit: number; readonly hasMore: boolean;',
    '      }>;',
    '    };',
    '    readonly jobs: {',
    ...
    '    };',
    '    readonly assets: {',
    '      search(input: { query: string | null; limit?: number; offset?: number }): Promise<SuperScriptAssetSearchPage>;',
    '      list(input?: { folderId?: string; recursive?: boolean; limit?: number; offset?: number }): Promise<SuperScriptAssetSearchPage>;',
    '      getMetadata(assetId: string): Promise<SuperScriptAssetMetadata>;',
    '      getAiContent(assetId: string): Promise<SuperAiContent>;',
    '      setMetadata(input: { assetId: string; expectedVersion: number; description?: string | null; rating?: 0 | 1 | 2 | 3 | 4 | 5; favorite?: boolean; sourcePageUrl?: string | null; author?: string | null }): Promise<SuperScriptAssetMetadata>;',
    '      getExtractedMetadata(assetId: string): Promise<SuperScriptExtractedMetadata>;',
    '      setRating(assetIds: readonly string[], rating: 0 | 1 | 2 | 3 | 4 | 5): Promise<SuperRatingUpdateResult>;',
    ...
    '    };',
    '    readonly trash: {',
    '      list(input?: { limit?: number; offset?: number }): Promise<SuperScriptAssetSearchPage>;',
    ...
    '    };',
    '    readonly palettes: {',
    '      mostFrequent(input?: { days?: number; limit?: number }): Promise<SuperRecentPalette>;',
    '    };',
    '    readonly ui: {',
    ...
    '  }',
    '',
    '  const super: SuperAutomationApi;',
    '}',
    '',
  ].join('\n');
}
