...
/** Super-8b5b.2: a dangerous call answered with a two-phase challenge instead of executing. */
...
export interface AutomationCommandGatewayOptions {
  ...
  /**
   * Super-ihpx: an automation import (MCP/script/console) completed — the
...
export function createAutomationCommandGateway(
  ...
  // Super-8b5b.4 review: cap idempotency retention so a chatty client with
  ...
  return {
    ...
    async execute(
      ...
      // Super-8b5b.2: challenge confirmation fields are stripped after the
      ...
      if (isCriticalOperation) {
        // Super-8b5b.2: dangerous commands are MCP-only and gated entirely
        ...
        // Super-8b5b.8 review: a read-only credential must be gated on
      ...
      // Super-ihpx: an automation import must behave like a human import —
