...
Super 支持通过 WebDAV 服务器在多台电脑之间同步资源库。全局配置服务器、每个资源库单独绑定，之后双向自动同步：本地变更上传、云端变更拉取。
...
![旧版参考：全局同步设置](../assets/ui/sync-settings.png)
...
![旧版参考：资源库同步设置](../assets/ui/library-sync.png)
...
![旧版参考：打开同步资源库](../assets/ui/open-sync-library.png)
