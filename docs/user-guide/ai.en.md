...
![AI configuration with the API key hidden; Chinese UI](../assets/ui/live-2.2.8/ai-settings.png)

The endpoint and model shown are the existing configuration of the captured instance, not a recommendation or universal settings. Use your provider's configuration.
...
![Existing AI tags, rating, palette, and description; Chinese UI](../assets/ui/live-2.2.8/ai-analysis-result.png)
...
![AI search input dialog; Chinese UI](../assets/ui/live-2.2.8/ai-search.png)

The following screenshot shows an already-saved anime smart collection, not a result generated by the empty query above.

![An existing smart collection; Chinese UI](../assets/ui/live-2.2.8/smart-collection.png)
