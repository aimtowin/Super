export const NOTIFICATIONS_ENABLED_KEY = 'superNotificationsEnabled';
export const FOCUS_APP_AFTER_SAVE_KEY = 'superFocusAppAfterSave';
export const REVEAL_IN_LIBRARY_AFTER_SAVE_KEY = 'superRevealInLibraryAfterSave';
export const DRAG_RADIAL_MENU_ENABLED_KEY = 'superDragRadialMenuEnabled';
...
/** Default on so Super surfaces after a browser save. */
