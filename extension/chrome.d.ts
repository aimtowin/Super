interface SuperContextMenuClickData {
...
interface SuperContextMenuShownInfo {
  contexts: Array<'image' | 'video' | 'audio' | 'page' | 'selection' | 'link'>;
}

interface SuperChromeApi {
  runtime: {
  ...
  contextMenus: {
    ...
    onClicked: {
      addListener(callback: (info: SuperContextMenuClickData) => void): void;
    };
    onShown?: {
      addListener(callback: (info: SuperContextMenuShownInfo) => void): void;
    };
  };
  tabs: {
...
declare const chrome: SuperChromeApi;
