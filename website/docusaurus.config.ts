...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          routeBasePath: 'docs',
          editUrl: 'https://github.com/dolag233/Super/edit/dev/website',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    image: 'assets/ui/Super-Preview.png',
    navbar: {
      title: 'Super',
      logo: {
        alt: 'Super Logo',
        src: 'assets/ui/Super-Logo.png',
        height: 32,
      },
      items: [
        ...
        {
          href: 'https://github.com/dolag233/Super',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: '项目',
          items: [
            { label: 'GitHub', href: 'https://github.com/dolag233/Super' },
