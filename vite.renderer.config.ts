...
/**
 * Pin the renderer dev server to SUPER_VITE_PORT (set by scripts/dev-start.mjs)
...
/**
 * HarmonyOS Sans SC ships discrete static faces (400/500/600/700). Super UI
...
export default defineConfig({
  ...
  build: {
    rollupOptions: {
      // Multi-page renderer build (slice E, Super-hnmg): the main window
