...
describe('resolveDragDropMode / resolveManagedDropEffect (Super-aa3)', () => {
  ...
  it('uses platform-correct modifier labels (Super-2vn)', () => {
...
describe('resolveCollectionDrop (Super-aa3)', () => {
