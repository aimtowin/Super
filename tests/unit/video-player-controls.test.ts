...
describe("matchVideoPlaybackSeekKey / videoSeekDeltaSeconds (Super-sk1)", () => {
  const base = {
    ctrlKey: false,
    metaKey: false,
    altKey: false,
  ...
  it("maps D/F to previous/next frame (Super-soii)", () => {
...
describe("matchVideoPlaybackRateKey / stepVideoPlaybackRate (Super-soii)", () => {
  const base = {
    ctrlKey: false,
    metaKey: false,
    altKey: false,
