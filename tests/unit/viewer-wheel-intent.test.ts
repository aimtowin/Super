...
describe('isPrimarilyHorizontalWheel (Super-4kg3)', () => {
...
describe('classifyViewerWheel (Super-yo0n)', () => {
  ...
  it('pans on ctrlKey when the delta is primarily horizontal (Super-4kg3)', () => {
...
describe('resolveWheelGestureAnchor (Super-yo0n gesture-start anchor)', () => {
