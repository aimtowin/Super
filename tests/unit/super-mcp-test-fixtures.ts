...
import type { SuperMcpToolExposure } from '../../src/mcp/tool-catalog';
...
export const readExposure: SuperMcpToolExposure = {
  accessMode: 'auto',
...
export const writeExposure: SuperMcpToolExposure = {
