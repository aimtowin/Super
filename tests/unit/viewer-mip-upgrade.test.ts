...
describe("viewer mip upgrade (Super-eh07)", () => {
  ...
  it("keeps placeholder visible until full image has decoded", () => {
    const placeholder = "super://preview/lib/art";
    const full = "super://source/lib/asset?revision=r1";
