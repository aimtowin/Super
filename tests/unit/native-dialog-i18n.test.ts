...
describe("native dialog i18n (Super-bwb)", () => {
  ...
  it('keeps Eagle open as two folder pickers: source then Super save location', () => {
    ...
    expect(enDest.title).toBe("Choose the parent folder for the new Super library");
    expect(zhDest.title).toBe("\u9009\u62e9\u7528\u6765\u5b58\u653e\u65b0 Super \u8d44\u6e90\u5e93\u7684\u7236\u6587\u4ef6\u5939");
