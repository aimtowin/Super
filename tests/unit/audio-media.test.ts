...
test("waveform cover geometry is approximately 4:3 (Super-dxk)", () => {
...
test("waveform cover stage is charcoal grey-black (Super-vlx)", () => {
  expect(
...
test("waveform cover stage contrasts with light canvas (Super-muc)", () => {
