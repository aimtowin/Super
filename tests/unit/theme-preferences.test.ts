...
describe('theme preferences', () => {
  it('defaults to system (clarification #11 / Super-svc)', () => {
...
describe('readSystemTheme E2E override', () => {
  it('honors __SUPER_E2E_THEME__ when present', () => {
    const previous = (globalThis as { __SUPER_E2E_THEME__?: string })
      .__SUPER_E2E_THEME__;
    try {
      ...
      if (previous === undefined) {
        delete (globalThis as { __SUPER_E2E_THEME__?: string })
          .__SUPER_E2E_THEME__;
      } else {
        (globalThis as { __SUPER_E2E_THEME__?: string }).__SUPER_E2E_THEME__ =
          previous;
