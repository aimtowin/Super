...
describe("fetchBrowseScopeIds (Super-ws4k select-all id set)", () => {
...
describe("fetchBrowseLayout (Super-sa65 compact geometry index)", () => {
...
describe("fetchBrowseScopeAssetIdsGuarded (Super-ws4k select-all race)", () => {
...
describe("registerBrowseSearchPage / registerBrowseSmartCollectionPage (Super-ws4k)", () => {
...
describe("discarded browse-window pages (Super-87pd)", () => {
