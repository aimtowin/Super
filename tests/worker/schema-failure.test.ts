// Super-verg.5 — migration failure diagnosis and retry (0031 §2.2):
// a rolled-back migration failure is recorded to .super/migration-failed.json,
...
function temporaryRoot(): string {
  const root = mkdtempSync(path.join(tmpdir(), 'super-schema-failure-'));
...
describe('migration failure integration (Super-verg.5)', () => {
