...
<D:multistatus xmlns:D="DAV:">
  ...
  <D:response>
    <D:href>/Share/Super/a.txt</D:href>
    <D:propstat>
      <D:prop>
    ...
    expect(entries[0]!.href).toBe('/Share/Super/test-library/');
    expect(entries[0]!.props.isCollection).toBe(true);
    expect(entries[1]!.href).toBe('/Share/Super/a.txt');
