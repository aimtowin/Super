// Super-verg.4 — migration atomicity (0031 §2.1): every migration must run
...
function temporaryRoot(): string {
  const root = mkdtempSync(path.join(tmpdir(), 'super-schema-compat-'));
...
describe('sync-first v37/v38 migration fork (Super-e0dw)', () => {
  ...
  // v40+ (Super-4bdd26): additive index migrations appended after v39. The
