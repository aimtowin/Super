// Super-verg review fix: the folder panel read paths (folder counts,
...
function temporaryRoot(): string {
  const root = mkdtempSync(path.join(tmpdir(), 'super-lenient-folder-'));
...
describe('folder panel lenient read (Super-verg review fix)', () => {
