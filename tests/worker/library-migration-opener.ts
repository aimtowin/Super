...
const libraryPath = process.env.SUPER_MIGRATION_LIBRARY_PATH;
const childId = process.env.SUPER_MIGRATION_CHILD_ID;
const releasePath = process.env.SUPER_MIGRATION_RELEASE_PATH;
