...
| `ascii-fbx.ts` | hand-written by Super (see builder) | MIT (Super) | FBX 7.4 ASCII: triangle + quad, normals/UVs, Lambert material, embedded/external PNG texture, configurable axis/unit/transform |
